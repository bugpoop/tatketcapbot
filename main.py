    ...
    while True:
        ...
        while True:
            ...
            if current > price + price*(2/10000):
                update.message.reply_text("BTC is up by %0.002. Current price is", price / 100)
                break
            if current < price - price*(2/10000):
                update.message.reply_text("BTC price is down by %0.002. Current price is", price / 100)
                break
            else:
                print("no change")
                time.sleep(600)
